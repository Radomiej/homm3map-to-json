...
public class MapObject implements Comparable<MapObject> {
    ...
    public static String getRandomMonsterDefName() {
        List<String> monstersDefs = MapObject.monsters.get(new Random(System.currentTimeMillis()).nextInt(6) + 1);
        return monstersDefs.get(new Random(System.currentTimeMillis()).nextInt(monstersDefs.size() - 1));
    }
    ...
    public static String getRandomDwellingDefNameByLevel(int level) {
        ...
        return levelDwellings.get(new Random(System.currentTimeMillis()).nextInt(levelDwellings.size() - 1));
    }
    ...
    public static int getRandomTown() {
        return new Random(System.currentTimeMillis()).nextInt(8);
    }

    public static String getRandomResourceDefName() {
        return RESOURCES[new Random(System.currentTimeMillis()).nextInt(RESOURCES.length - 1)];
    }
...
//    }
    ...
    public static class Art {
        ...
        public static int getRandomArtId(int artLevel) {
            ...
            int randomInt = new Random(System.currentTimeMillis()).nextInt(max - min) + min;
